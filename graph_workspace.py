...
{recovery_script}
    ...
    def _register_settings_callbacks(self, app):
        ...
        defaults = {
            ...
            self.settings_id("InputSizePlot"): {"value": self.initial_height},
            self.settings_id("InputSizePlotW"): {"value": self.initial_width},
            ...
            self.settings_id("font-size-legend"): {"value": 12},
