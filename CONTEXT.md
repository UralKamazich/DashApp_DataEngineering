...
2. **Страница ML** — CatBoost-регрессия/классификация, встроенный автоподбор (random search), фоновые задания с прогрессом/отменой уже работают; далее расширять диагностику и добавлять новые семейства моделей
